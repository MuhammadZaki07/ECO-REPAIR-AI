...
export default function DonationDetailPage() {
  ...
  const progress = (detail.current_eco_coin / detail.goal_eco_coin) * 100;
  ...
  return (
    <div className="max-w-7xl mx-auto w-full">
      ...
      <Card className="overflow-hidden mb-10 p-0">
        <div className="h-[360px] w-full bg-emerald-500/10 flex items-center justify-center text-7xl">
          IMG
        </div>
      </Card>
          ...
          <section className="pt-10 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold">
                Donors ({detail.donors.length})
              </h3>
            </div>

            {detail.donors.length === 0 && (
              <p className="text-sm text-muted-foreground">
                Be the first one who supports this campaign 💚
              </p>
            )}
            ...
            <CardContent className="p-6 space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  <span>
                    {detail.current_eco_coin} / {detail.goal_eco_coin} EC
                  </span>
                  <span className="font-semibold text-emerald-600">
