...
export function UserXPHistoryModal({
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-neutral-900 w-full max-w-3xl rounded-xl shadow-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 flex flex-col max-h-[90vh]">
        <div className="relative p-6">
          ...
          <div className="flex items-center gap-3 mb-2">
            <h2 className="text-2xl md:text-3xl font-bold">XP History</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {loadingUserXPHistory ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">No XP History Yet</h3>
