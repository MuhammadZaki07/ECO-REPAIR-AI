  ...
  return (
    <button
      ...
      className={`w-full flex cursor-pointer ${mini ? "justify-center" : "justify-normal"} items-center gap-3 px-3 py-2.5 text-sm rounded-lg transition-colors 
        ${active ? 'dark:bg-neutral-800 bg-neutral-200 text-neutral-700 dark:text-neutral-100' : 'text-neutral-800 dark:text-neutral-100 hover:bg-[var(--sidebar-accent)] hover:text-[var(--sidebar-accent-foreground)]'}`}
    >
      {icon}
