...
const GitHubButton: React.FC = () => {
  ...
  return (
    <div className='flex justify-center'>
      <a
        href='https://github.com/MuhammadZaki07/ECO-REPAIR-AI'
        target='_blank'
        className='relative inline-block w-11 h-11 mx-auto group dark:bg-black bg-white dark:border-white border-black border-2 rounded-lg'
      >
        ...
        >
          <span className='flex items-center justify-center rounded-lg group-hover:text-yellow-400 text-white text-xl font-semibold tracking-wide whitespace-nowrap'>
            <Github className='inline-block group-hover:fill-yellow-400 fill-white w-6 h-6 shrink-0 ml-0.5' />{' '}
          </span>
        </button>
      </a>
    </div>
