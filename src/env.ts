export const ENV = {
  ...
  BUCKET_MERCHANDISE: import.meta.env.VITE_BUCKET_MERCHANDISE,
  FOLDER_MERCHANDISE: import.meta.env.VITE_FOLDER_MERCHANDISE,

  BUCKET_CAMPAIGNS: import.meta.env.VITE_BUCKET_CAMPAIGNS,
  FOLDER_CAMPAIGNS: import.meta.env.VITE_FOLDER_CAMPAIGNS,
};
